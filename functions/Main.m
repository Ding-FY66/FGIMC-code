function [U,F,obj] = Main(Sor_ini,alpha_ini,B_ini,U_ini,D_ini,F_ini,r,num_cluster,numInst,numview,lambda1,lambda2,lambda3,max_iter,ind_folds)
...
for iter = 1:max_iter
    ...
    for i=1:numview
        ...
        [T,~]=choose_neighbor_coefficient(T,20,23); 
        T=(T+T')/2;
        A{i}=T.*Sor{i};
